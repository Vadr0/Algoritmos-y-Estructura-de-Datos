...
public class Prueba {
    public static void main(String[] args) {
        ...
        System.out.println("Total de nodos (hojas y no hojas): " + arbol.countAllNodes());  // Esperado: 7

        // B. countNodes()
        System.out.println("\n--- Probando countNodes() ---");
        System.out.println("Nodos NO hoja: " + arbol.countNodes());  // Esperado: nodos con hijos
        ...
        System.out.println("Altura del nodo inexistente (100): " + arbol.height(100)); // -1
        ...
        System.out.println("¿ta vacío?: " + arbol.isEmpty());

        // Intentamos destruir otra vez
        try {
            arbol.destroyNodes();
        } catch (ExceptionIsEmpty e) {
            System.out.println("Excepcion al destruir de nuevo: " + e.getMessage());
        }
    }
}
